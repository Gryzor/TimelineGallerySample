...
public abstract class TimelineGalleryAbsSpinner extends TimelineGalleryAdapterView<SpinnerAdapter> {
	...
	public TimelineGalleryAbsSpinner(Context context) {
		super(context);
		initAbsSpinner();
	}
	public TimelineGalleryAbsSpinner(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}
	public TimelineGalleryAbsSpinner(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Jump directly to a specific item in the adapter data.
	 */
	public void setSelectionAnimated(int position) {
		// Animate only if requested position is already on screen somewhere
		setSelectionInt(position, true);
	}
	@Override
	...
	static class SavedState extends BaseSavedState {
		...
		int position;
		/**
		 * Constructor called from {@link TimelineGalleryAbsSpinner#onSaveInstanceState()}
		 */
