...
public abstract class TimelineGalleryAdapterView<T extends Adapter> extends ViewGroup {
	/**
	...
	public TimelineGalleryAdapterView(Context context) {
		super(context);
	}
	public TimelineGalleryAdapterView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	public TimelineGalleryAdapterView(Context context, AttributeSet attrs, int defStyle) {
	...
	public interface OnItemClickListener {
		 ...
		 */
		void onItemClick(TimelineGalleryAdapterView<?> parent, View view, int position, long id);
	}
	/**
	...
	public interface OnItemLongClickListener {
		 ...
		 */
		boolean onItemLongClick(TimelineGalleryAdapterView<?> parent, View view, int position, long id);
	}
	/**
	 * Register a callback to be invoked when an item in this AdapterView has
	...
	public interface OnItemSelectedListener {
		 ...
		 */
		void onItemSelected(TimelineGalleryAdapterView<?> parent, View view, int position, long id);
		/**
		 ...
		 */
		void onNothingSelected(TimelineGalleryAdapterView<?> parent);
	}
	/**
	 * Register a callback to be invoked when an item in this AdapterView has
	 * been selected.
	...
	class AdapterDataSetObserver extends DataSetObserver {
		...
		public void onChanged() {
			...
			if (TimelineGalleryAdapterView.this.getAdapter().hasStableIds() && mInstanceState != null && mOldItemCount == 0
					&& mItemCount > 0) {
				TimelineGalleryAdapterView.this.onRestoreInstanceState(mInstanceState);
				mInstanceState = null;
			} else {
				rememberSyncState();
			}
		...
		public void onInvalidated() {
			mDataChanged = true;
			if (TimelineGalleryAdapterView.this.getAdapter().hasStableIds()) {
				// Remember the current state for the case where our hosting
				// activity is being
				// stopped and later restarted
				mInstanceState = TimelineGalleryAdapterView.this.onSaveInstanceState();
			}
